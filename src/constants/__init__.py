...
"""
MODEL_EVALUATION_CHANGED_THRESHOLD_SCORE: float = 0.02 # it compare the previous model with new model if the performance threshold more than or equal to 0.02 then fush that model in server otherwise no need to push
